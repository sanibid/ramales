...
class Ui_BlockDialog(object):
    def setupUi(self, BlockDialog):
        ...
        self.date.setDate(datetime.datetime.today().date())
        ...
        self.totalLengthLabel = QtWidgets.QLabel(self.generalBox)
        self.totalLengthLabel.setObjectName("totalLengthLabel")
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.totalLengthLabel)
        self.totalLength = QtWidgets.QDoubleSpinBox(self.generalBox)
        self.totalLength.setEnabled(False)
        self.totalLength.setDecimals(2)
        self.totalLength.setMaximum(99999999999999.0)
        self.totalLength.setObjectName("totalLength")
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.totalLength)
        ...
        self.revisionDate.setDate(datetime.datetime.today().date())
        ...
        self.os_name_lb = QtWidgets.QLabel(self.groupBox_2)
        self.os_name_lb.setObjectName("os_name_lb")
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.os_name_lb)
        self.os_name_le = QtWidgets.QLineEdit(self.groupBox_2)
        self.os_name_le.setObjectName("os_name_le")
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.os_name_le)
        ...
        BlockDialog.setTabOrder(self.revisionDate, self.os_name_lb)
