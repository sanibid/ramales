...
class RepOutDataCostsUI():
    ...
    def showReportCosts(self):
        ...
        self.screen.setGeometry(int((geometry.width() - (self.table.horizontalHeader().length()) * 1.1) / 2.0),
                                int((geometry.height() - self.table.verticalHeader().length()) / 2.0),
                                int(round(self.table.horizontalHeader().length() * 1.055, 0)),
                                int(round(self.table.verticalHeader().length() * 1.2, 0)))
        self.screen.exec_()

    def loadReportCosts(self, costs, title):
        self.costs = costs
        self.title = title
    ...
    def loadTable(self):
        ...
        self.dsb_item01_unity_dollar.setValue(self.costs.prices.price_5_2_55)
        self.dsb_item02_unity_dollar.setValue(self.costs.prices.price_5_2_67)
        self.dsb_item03_unity_dollar.setValue(self.costs.prices.price_6_1_4)
        self.dsb_item04_unity_dollar.setValue(self.costs.prices.price_6_2_4)
        self.dsb_item05_unity_dollar.setValue(self.costs.prices.price_6_1_1)
        self.dsb_item06_unity_dollar.setValue(self.costs.prices.price_6_2_1)
        self.dsb_item07_unity_dollar.setValue(self.costs.prices.price_7_9_2)
        self.dsb_item08_unity_dollar.setValue(self.costs.prices.price_9_1_1)
        self.dsb_item09_unity_dollar.setValue(self.costs.prices.price_9_7_1)
        self.dsb_item10_unity_dollar.setValue(self.costs.prices.price_9_6_1)
        self.dsb_item11_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item12_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item13_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item14_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item15_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item16_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item17_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item18_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item19_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item20_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item21_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item22_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item23_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item24_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item25_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item26_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item27_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item28_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item29_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item30_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item31_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item32_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item33_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item34_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item35_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item36_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item37_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item38_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item39_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        self.dsb_item40_unity_dollar.setValue(self.costs.prices.price_50_99_22)
        ...
        self.table.setItem(i, 3, QTableWidgetItem(self.utils.formatNum2Dec(self.costs.get_5_2_55_qtd())))
        ...
        self.table.setItem(i, 2, QTableWidgetItem(self.translate('m²')))
        self.table.setItem(i, 3, QTableWidgetItem(self.utils.formatNum2Dec(self.costs.get_5_2_67_qtd())))
        ...
        self.table.setItem(i, 2, QTableWidgetItem(self.translate('m²')))
        self.table.setItem(i, 3, QTableWidgetItem(self.utils.formatNum2Dec(self.costs.get_6_1_4_qtd())))
        ...
        self.table.setItem(i, 2, QTableWidgetItem(self.translate('m²')))
        self.table.setItem(i, 3, QTableWidgetItem(self.utils.formatNum2Dec(self.costs.get_6_2_4_qtd())))
        ...
        self.table.setItem(i, 2, QTableWidgetItem(self.translate('m')))
        self.table.setItem(i, 3, QTableWidgetItem(self.utils.formatNum2Dec(self.costs.get_6_2_1_qtd())))
        ...
        self.table.setItem(i, 2, QTableWidgetItem(self.translate('m³')))
        self.table.setItem(i, 3, QTableWidgetItem(self.utils.formatNum2Dec(self.costs.get_7_9_2_qtd())))
        ...
        self.table.setItem(i, 2, QTableWidgetItem(self.translate('m³')))
        self.table.setItem(i, 3, QTableWidgetItem(self.utils.formatNum2Dec(self.costs.get_9_1_1_qtd())))
        ...
        self.table.setItem(i, 2, QTableWidgetItem(self.translate('m³')))
        self.table.setItem(i, 3, QTableWidgetItem(self.utils.formatNum2Dec(self.costs.get_9_7_1_qtd())))
        ...
        self.table.setItem(i, 2, QTableWidgetItem(self.translate('m³')))
        self.table.setItem(i, 3, QTableWidgetItem(self.utils.formatNum2Dec(self.costs.get_9_6_1_qtd())))
        ...
        self.table.setItem(i, 2, QTableWidgetItem(self.translate('m³')))
        self.table.setItem(i, 3, QTableWidgetItem(self.utils.formatNum2Dec(self.costs.get_50_99_22_qtd())))
        self.table.setCellWidget(i, 4, self.dsb_item11_unity_dollar)
        self.table.setItem(i, 5, QTableWidgetItem(self.utils.formatNum2Dec(self.costs.get_50_99_22_price())))
        i += 1
        self.table.setItem(i, 0, QTableWidgetItem(str(i - 3)))
        self.table.setItem(i, 1, QTableWidgetItem(self.translate(
        ...
        self.table.item(i, 0).setFont(self.utils.formatBoldText())
        i += 1
        self.table.setItem(i, 0, QTableWidgetItem(str(i - 10)))
